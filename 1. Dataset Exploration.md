### <ins>General Observations regarding the dataset:</ins>
...
---
:zap: Total of unique products per category along with the total Revenue they generated:
```ruby
...
:zap: Total product sales per location & individual transactions per location:
```ruby
...
:speech_balloon: The Location "Gutten Plans" has the most sales in total (1st query) & Only 4.5% of the customers using the vending machines buy multiple products at once (2nd query).
