...
|- A total of 37 products have sold less than 5 items and are considered low performance. Out of them 24/37 (65%) are in the **"Food"** category.|
...
```ruby
#Products with less or equal than 5 total sales (Low performance)
Select Category,Count(Category) as Number_of_products
from(
Select category,product,sum(RQty) as Sales
FROM sakila.vending_machine_sales
...
![image](https://user-images.githubusercontent.com/69303154/209806294-8e9d9ef3-105e-4c88-8e08-07494c0c1228.png)

- A total of 37 products have sold less than 5 items and are considered low performance.
- Again 24/37 (65%) are in the Food category.
